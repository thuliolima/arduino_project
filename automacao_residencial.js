function AlteraRele1(){
    ...
    if(estado_1 === "0"){
		...
		document.getElementById("botao_1").innerHTML="<a href='/?desligar' class='botao_1'>Desliga</a>";
    } else {
        document.getElementById("estado_1").innerHTML="0";
        document.getElementById("rele_1").innerHTML="<div class='rele1_desligado'></div>";
        document.getElementById("botao_1").innerHTML="<a href='/?ligar' class='botao_1'>Liga</a>";
    }
}
...
function AlteraRele4(){
    ...
    if(estado_4 === "0"){
		...
		document.getElementById("botao_4").innerHTML="<a href='/?2_desligar' class='botao_4'>Desliga</a>";
    } else {
